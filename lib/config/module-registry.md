...
| - | sync.archive_file | `""` | [impl] | sync | Board archive a closed row moves to; empty means `BACKLOG-archive.md` beside the board. A linked spoke card closes only when its id sits there with a closed status. |
