...
entries live there. This root file is a thin entry point kept short so a newcomer isn't buried
on arrival; `/kit:ship` and `/kit:kit-health` both write to and read from `docs/CHANGELOG.md`
directly (SPEC-185).
