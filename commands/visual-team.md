...
Take the visual design from one of: a screenshot path, a URL, a written description, or a `## Visual` section in `docs/briefs/DECISION-BRIEF-<slug>.md` (falling back to the legacy `docs/briefs/DECISION-BRIEF.md`). If none is provided, ask the user for one (a screenshot, link, or description) and stop.
...
## Visual critique
Date: [date]
Visual source: [path | URL | description | DECISION-BRIEF-<slug>.md ## Visual]
