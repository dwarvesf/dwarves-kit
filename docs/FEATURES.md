...
| `/kit:verify` | `[H/I]` | Re-run the test levels (kit:task-verifier + kit:integration-verifier + kit:acceptance-verifier + kit:system-verifier) on the current spec/b… | SPEC-002, SPEC-003, SPEC-006 +38 | test-break-it.sh, test-codex-hooks.sh, test-command-emit-sweep.sh +8 |
