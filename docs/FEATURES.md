...
| `/kit:docs` | `[H/I]` | Update all project documentation to match the current codebase. Cross-references the diff against every doc file and fixes drift. | SPEC-001, SPEC-002, SPEC-003 +183 | proof-loop-09-scenario-b.sh, run-workflow.sh, test-adopt.sh +63 |
...
| `/kit:next` | `[H/I]` | Pick up the next undone task from the spec. Loads context, shows acceptance criteria, lets you drive the implementation. | SPEC-001, SPEC-002, SPEC-003 +83 | test-advisor-ledger-emit.sh, test-advisor.sh, test-agent-effectiveness.sh +31 |
