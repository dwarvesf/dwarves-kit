...
| `/kit:think` | `[H/I]` | Challenge an idea before writing any spec. 6 forcing questions that reframe the product. Use when the operator brings a new idea, feature, … | SPEC-003, SPEC-004, SPEC-005 +30 | test-command-emit-sweep.sh, test-command-triggers.sh, test-config-stamp.sh +8 |
