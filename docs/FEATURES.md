...
| `/kit:spec` | `[H/I]` | Generate a development spec from a feature idea or decision brief. Creates docs/specs/ with structured requirements. | SPEC-001, SPEC-002, SPEC-003 +163 | test-bin-forwarders.sh, test-break-it.sh, test-codex-hooks.sh +46 |
