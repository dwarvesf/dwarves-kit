# Sample quiz (fixture A, ref deadbeefdeadbeefdeadbeefdeadbeefdeadbeef)

# 5-question understanding quiz for `deadbeefdeadbeefdeadbeefdeadbeefdeadbeef`
# Grounded in the ACTUAL diff + recorded test results, NOT any agent narrative.
# These questions are the payload for the understand.teach mastery gate, they are not scored here.
