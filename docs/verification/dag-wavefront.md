...
- Command: `cd ~/workspace/tieubao/dwarves-kit && bash tests/test-orchestrate-wavefront.sh && bash tests/test-orchestrate.sh`
- Exit: 0
- Output (excerpt): wavefront 89/89 `ALL PASS` (five `EXIT-CRITERION` markers + Option-B honesty control), orchestrate 59/59 `ALL PASS`. `shellcheck -s bash lib/orchestrate.sh` exit 0 (after 2274ad3).
