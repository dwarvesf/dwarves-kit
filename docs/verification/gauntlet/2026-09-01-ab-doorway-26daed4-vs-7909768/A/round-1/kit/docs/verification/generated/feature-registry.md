...
> GENERATED by `lib/gate/proof-table-gen.sh` from the gate/run ledger (`~/.local/state/dwarves-kit/logs/runs/feature-registry.log`). Do NOT hand-edit -- regenerate instead. Companion run-table, not the canonical `proof-of-done.md` (SPEC-016: generators write under `docs/verification/generated/`, never the canonical).
...
(reads `~/.local/state/dwarves-kit/logs/runs/feature-registry.log`; regenerating overwrites only this generated file, never the canonical.)
