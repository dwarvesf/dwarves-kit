...
- [x] 03-wire-mega , `[mega]` (wave_cap, tier4_close, multiplexer, merge_autonomy, mega_merge_posture) via resolver; default_model/over_test as GLOBAL fallback (goal-file field > project > kit-root) , `auto`, PR #215 , merged 72f0bac (CI green; proof docs/verification/ho-03-wire-mega/proof-of-done.md; the docs/runs/harness-ops-03-mega.md seam was folded into 13's relocation)
