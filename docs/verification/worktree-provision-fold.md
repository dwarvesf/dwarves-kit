...
Change under proof:
1. `lib/worktree-provision/` folds in ops-toolkit `tools/cc-worktree-provision`
...
| 6 | bin/ chain runs from repo | `bin/cc-intel --help; bin/cc-worktree-provision --dry-run --base /tmp` | usage printed; `no-op` | PASS |
