...
You receive:
- **The brief itself**: `docs/briefs/DECISION-BRIEF-<slug>.md` if present (falling back to the legacy `docs/briefs/DECISION-BRIEF.md`), else the Problem/Context section of the target `docs/specs/SPEC-NNN-<slug>.md`, or the brief text pasted inline.
