...
description: Quick brownfield orientation for a target area (endpoints, data models, UI, test coverage, recent history) -- capped at 80 lines, throwaway context for a spec about to be written. Dispatched by /spec, /test-plan. Read-only.
tools:
  - Read
  - Grep
  - Glob
