...
Write to `docs/research/<date>-<slug>-architecture.md` (the dispatch prompt supplies `<date>` and `<slug>`; if neither was supplied, fall back to `docs/research/architecture.md`):
