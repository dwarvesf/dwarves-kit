...
kit_module_hooks() {
  case "$1" in
    ...
    session) echo "context-readiness.sh output-offload.sh pre-compact-backup.sh post-compact-reinject.sh session-state-save.sh harvest.sh citation-guard.sh context-budget.sh" ;;
