...
EXPECTED="activate board classify config gate goal learn lint mega plugin-check precedent prose-rag queue release session skill-improve skill-review spec stats worktree-provision wrap"
